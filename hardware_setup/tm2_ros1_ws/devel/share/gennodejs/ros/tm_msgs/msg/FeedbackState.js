...
class FeedbackState {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.uint8(obj.camera_light, buffer, bufferOffset);
    ...
    bufferOffset = _arraySerializer.uint8(obj.cb_digital_output, buffer, bufferOffset, null);
    // Serialize message field [cb_digital_input]
    bufferOffset = _arraySerializer.uint8(obj.cb_digital_input, buffer, bufferOffset, null);
    ...
    bufferOffset = _arraySerializer.uint8(obj.ee_digital_output, buffer, bufferOffset, null);
    // Serialize message field [ee_digital_input]
    bufferOffset = _arraySerializer.uint8(obj.ee_digital_input, buffer, bufferOffset, null);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.camera_light = _deserializer.uint8(buffer, bufferOffset);
    ...
    data.cb_digital_output = _arrayDeserializer.uint8(buffer, bufferOffset, null)
    // Deserialize message field [cb_digital_input]
    data.cb_digital_input = _arrayDeserializer.uint8(buffer, bufferOffset, null)
    ...
    data.ee_digital_output = _arrayDeserializer.uint8(buffer, bufferOffset, null)
    // Deserialize message field [ee_digital_input]
    data.ee_digital_input = _arrayDeserializer.uint8(buffer, bufferOffset, null)
  ...
  static md5sum() {
    ...
    return '7216acdb2ff205805699d65e92406aae';
  }
