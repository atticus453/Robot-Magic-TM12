...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<WriteItem-request>)))
  ...
  (cl:format cl:nil "# 'Write'~%# id        : name~%# item/value: More details please refer to the TM Expression Editor Manual(2.12 rev1.00) Chapter 14.6 TMSVR vs Chapter 14.3 svr_write~%~%string id~%string item~%string value~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'WriteItem-request)))
  "Returns full string definition for message of type 'WriteItem-request"
  (cl:format cl:nil "# 'Write'~%# id        : name~%# item/value: More details please refer to the TM Expression Editor Manual(2.12 rev1.00) Chapter 14.6 TMSVR vs Chapter 14.3 svr_write~%~%string id~%string item~%string value~%~%~%"))
