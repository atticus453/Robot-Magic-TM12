...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AskItem-request>)))
  ...
  (cl:format cl:nil "# Ask: request 'Read'~%# id        : The description you want to name. ~%# item      : More details please refer to the TM Expression Editor Manual(2.12 rev1.00) Chapter 14.6 TMSVR vs Chapter 14.2 svr_read~%# wait_time : set wait time.~%# More details please refer to the TM Expression Editor Manual(2.12 rev1.00) Chapter 14.6 TMSVR~%~%string id~%string item~%~%float64 wait_time~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AskItem-request)))
  "Returns full string definition for message of type 'AskItem-request"
  (cl:format cl:nil "# Ask: request 'Read'~%# id        : The description you want to name. ~%# item      : More details please refer to the TM Expression Editor Manual(2.12 rev1.00) Chapter 14.6 TMSVR vs Chapter 14.2 svr_read~%# wait_time : set wait time.~%# More details please refer to the TM Expression Editor Manual(2.12 rev1.00) Chapter 14.6 TMSVR~%~%string id~%string item~%~%float64 wait_time~%~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AskItem-response>)))
  ...
  (cl:format cl:nil "# ok        : read status ~%bool ok~%~%# id        : The description you want to name.~%# value     : The value of asked item.~%string id~%string value~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AskItem-response)))
  "Returns full string definition for message of type 'AskItem-response"
  (cl:format cl:nil "# ok        : read status ~%bool ok~%~%# id        : The description you want to name.~%# value     : The value of asked item.~%string id~%string value~%~%~%~%"))
