...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AskSta-request>)))
  ...
  (cl:format cl:nil "# Ask: request 'Read' sta~%# More details please refer to the TM Expression Editor Manual(2.12 rev1.00) Chapter 11.5 TMSTA~%# wait_time : set wait time.~%~%string subcmd~%string subdata~%~%float64 wait_time~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AskSta-request)))
  "Returns full string definition for message of type 'AskSta-request"
  (cl:format cl:nil "# Ask: request 'Read' sta~%# More details please refer to the TM Expression Editor Manual(2.12 rev1.00) Chapter 11.5 TMSTA~%# wait_time : set wait time.~%~%string subcmd~%string subdata~%~%float64 wait_time~%~%~%~%"))
