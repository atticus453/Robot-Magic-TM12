...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <FeedbackState>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'camera_light)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <FeedbackState>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'joint_tor_max)))
    ...
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'camera_light)) (cl:read-byte istream))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<FeedbackState>)))
  ...
  "7216acdb2ff205805699d65e92406aae")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'FeedbackState)))
  "Returns md5sum for a message object of type 'FeedbackState"
  "7216acdb2ff205805699d65e92406aae")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<FeedbackState>)))
  ...
  (cl:format cl:nil "Header header~%~%# Connection Status~%bool is_svr_connected       # Ethernet connection~%bool is_sct_connected       # Listen Node connection~%~%# Response ROS Node Status~%int32 tmsrv_cperr           # TM Ethernet Slave Communication Last CPERR Error Code~%int32 tmscript_cperr        # External Script Communication Last CPERR Error Code~%int32 tmsrv_dataerr         # TMSVR Communication Last Data Error Code~%int32 tmscript_dataerr      # External Script Communication TMSCT (or TMSTA) Last Data Error Code~%~%# Disconnection Message~%int32 max_not_connect_in_s~%int32 disconnection_times~%~%# Movement~%float64[] joint_pos~%float64[] joint_vel~%float64[] joint_tor~%float64[] tool0_pose         # flange_pose~%float64[] tool_pose~%float64[] tcp_speed~%float64[] tcp_force~%~%# Torque Data(for TM-Flow 1.84)~%float64[] joint_tor_average~%float64[] joint_tor_min~%float64[] joint_tor_max~%~%# Status~%bool robot_link              # Link Robot Controller~%bool is_data_table_correct   # Data Table Setting is Correct~%bool robot_error             # Error or Not~%bool project_run             # Project Runing or not~%bool project_pause           # Project Pause or not~%bool safetyguard_a           # Safety IO(Safeguard Port A trigger) ~%bool e_stop                  # Emergency STOP~%uint8 camera_light           # Light~%int32 error_code             # Last Error Code~%int32 project_speed          # Project Running Speed~%int32 ma_mode                # M/A Mode~%int32 robot_light            # Robot light~%~%# IO~%uint8[] cb_digital_output~%uint8[] cb_digital_input~%float32[] cb_analog_output~%float32[] cb_analog_input~%uint8[] ee_digital_output~%uint8[] ee_digital_input~%float32[] ee_analog_output~%float32[] ee_analog_input~%~%# String~%string error_content~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'FeedbackState)))
  "Returns full string definition for message of type 'FeedbackState"
  (cl:format cl:nil "Header header~%~%# Connection Status~%bool is_svr_connected       # Ethernet connection~%bool is_sct_connected       # Listen Node connection~%~%# Response ROS Node Status~%int32 tmsrv_cperr           # TM Ethernet Slave Communication Last CPERR Error Code~%int32 tmscript_cperr        # External Script Communication Last CPERR Error Code~%int32 tmsrv_dataerr         # TMSVR Communication Last Data Error Code~%int32 tmscript_dataerr      # External Script Communication TMSCT (or TMSTA) Last Data Error Code~%~%# Disconnection Message~%int32 max_not_connect_in_s~%int32 disconnection_times~%~%# Movement~%float64[] joint_pos~%float64[] joint_vel~%float64[] joint_tor~%float64[] tool0_pose         # flange_pose~%float64[] tool_pose~%float64[] tcp_speed~%float64[] tcp_force~%~%# Torque Data(for TM-Flow 1.84)~%float64[] joint_tor_average~%float64[] joint_tor_min~%float64[] joint_tor_max~%~%# Status~%bool robot_link              # Link Robot Controller~%bool is_data_table_correct   # Data Table Setting is Correct~%bool robot_error             # Error or Not~%bool project_run             # Project Runing or not~%bool project_pause           # Project Pause or not~%bool safetyguard_a           # Safety IO(Safeguard Port A trigger) ~%bool e_stop                  # Emergency STOP~%uint8 camera_light           # Light~%int32 error_code             # Last Error Code~%int32 project_speed          # Project Running Speed~%int32 ma_mode                # M/A Mode~%int32 robot_light            # Robot light~%~%# IO~%uint8[] cb_digital_output~%uint8[] cb_digital_input~%float32[] cb_analog_output~%float32[] cb_analog_input~%uint8[] ee_digital_output~%uint8[] ee_digital_input~%float32[] ee_analog_output~%float32[] ee_analog_input~%~%# String~%string error_content~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
