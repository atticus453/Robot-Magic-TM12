...
class FeedbackState(genpy.Message):
  _md5sum = "7216acdb2ff205805699d65e92406aae"
...
"""
  ...
  _slot_types = ['std_msgs/Header','bool','bool','int32','int32','int32','int32','int32','int32','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','bool','bool','bool','bool','bool','bool','bool','uint8','int32','int32','int32','int32','uint8[]','uint8[]','float32[]','float32[]','uint8[]','uint8[]','float32[]','float32[]','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.cb_digital_output is None:
        self.cb_digital_output = b''
      if self.cb_digital_input is None:
        self.cb_digital_input = b''
      ...
      if self.ee_digital_output is None:
        self.ee_digital_output = b''
      if self.ee_digital_input is None:
        self.ee_digital_input = b''
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.cb_digital_output = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      end += length
      self.cb_digital_input = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.ee_digital_output = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      end += length
      self.ee_digital_input = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
